...
class OffersRankings implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'id_product' => 'int',
        'condition' => '\KauflandSellerApi\Model\BuyboxCondition',
        'storefront' => '\KauflandSellerApi\Model\Storefront',
        'num_units' => 'float',
        'units' => '\KauflandSellerApi\Model\BuyboxUnit[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('num_units', $data ?? [], null);
    ...
    */
     ...
     * Gets condition
     *
     * @return \KauflandSellerApi\Model\BuyboxCondition
     */
     ...
     * Sets condition
     *
     * @param \KauflandSellerApi\Model\BuyboxCondition $condition condition
     *
     * @return self
     */
     ...
     * Sets num_units
     *
     * @param float $num_units Total number of offers for the given product
     *
     * @return self
     */
    public function setNumUnits($num_units)
    {
        if (is_null($num_units)) {
            throw new \InvalidArgumentException('non-nullable num_units cannot be null');
        }
     ...
     * Gets units
     *
     * @return \KauflandSellerApi\Model\BuyboxUnit[]
     */
     ...
     * Sets units
     *
     * @param \KauflandSellerApi\Model\BuyboxUnit[] $units units
     *
     * @return self
     */
