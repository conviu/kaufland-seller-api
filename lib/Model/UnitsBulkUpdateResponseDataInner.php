...
class UnitsBulkUpdateResponseDataInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'message' => 'string',
        'errors' => '\KauflandSellerApi\Model\UnitsBulkUpdateErrorDetail[]',
        'key' => 'string'
    ];
    ...
    */
    ...
    public function setIdUnit($id_unit)
    {
        ...
        if (($id_unit < 1)) {
            throw new \InvalidArgumentException('invalid value for $id_unit when calling UnitsBulkUpdateResponseDataInner., must be bigger than or equal to 1.');
        }
    ...
    public function setStatusCode($status_code)
    {
        ...
        if (($status_code < 200)) {
            throw new \InvalidArgumentException('invalid value for $status_code when calling UnitsBulkUpdateResponseDataInner., must be bigger than or equal to 200.');
        }
     ...
     * Gets errors
     *
     * @return \KauflandSellerApi\Model\UnitsBulkUpdateErrorDetail[]
     */
     ...
     * Sets errors
     *
     * @param \KauflandSellerApi\Model\UnitsBulkUpdateErrorDetail[] $errors errors
     *
     * @return self
     */
