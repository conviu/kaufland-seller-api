...
class ProductWithEmbedded implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'category' => '\KauflandSellerApi\Model\Category',
        'category_basic' => '\KauflandSellerApi\Model\CategoryBasic',
        'units' => '\KauflandSellerApi\Model\ProductUnitEmbedded[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('category_basic', $data ?? [], null);
    ...
    */
    ...
    public function setIdProduct($id_product)
    {
        ...
        if (($id_product < 1)) {
            throw new \InvalidArgumentException('invalid value for $id_product when calling ProductWithEmbedded., must be bigger than or equal to 1.');
        }
    ...
    public function setIdCategory($id_category)
    {
        ...
        if (($id_category < 1)) {
            throw new \InvalidArgumentException('invalid value for $id_category when calling ProductWithEmbedded., must be bigger than or equal to 1.');
        }
     ...
     * Sets category
     *
     * @param \KauflandSellerApi\Model\Category|null $category category
     *
     * @return self
     */
     ...
     * Gets category_basic
     *
     * @return \KauflandSellerApi\Model\CategoryBasic|null
     */
     ...
     * Sets category_basic
     *
     * @param \KauflandSellerApi\Model\CategoryBasic|null $category_basic category_basic
     *
     * @return self
     */
    public function setCategoryBasic($category_basic)
    {
        if (is_null($category_basic)) {
            throw new \InvalidArgumentException('non-nullable category_basic cannot be null');
        }
     ...
     * Gets units
     *
     * @return \KauflandSellerApi\Model\ProductUnitEmbedded[]|null
     */
     ...
     * Sets units
     *
     * @param \KauflandSellerApi\Model\ProductUnitEmbedded[]|null $units units
     *
     * @return self
     */
