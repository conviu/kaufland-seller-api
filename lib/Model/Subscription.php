...
class Subscription implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('id_subscription', $data ?? [], null);
    ...
    */
     ...
     *
     * @param float $id_subscription id_subscription
     *
     * @return self
     */
    public function setIdSubscription($id_subscription)
    {
        if (is_null($id_subscription)) {
            throw new \InvalidArgumentException('non-nullable id_subscription cannot be null');
        }
     ...
     * Gets event_name
     *
     * @return \KauflandSellerApi\Model\SubscriptionEventName
     */
     ...
     * Sets event_name
     *
     * @param \KauflandSellerApi\Model\SubscriptionEventName $event_name event_name
     *
     * @return self
     */
