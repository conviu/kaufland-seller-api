...
class UnitsBulkUpdateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'id_unit' => 'int',
        'unit_data' => '\KauflandSellerApi\Model\UnitPatchRequest'
    ];
    ...
    */
    ...
    public function setIdUnit($id_unit)
    {
        ...
        if (($id_unit < 1)) {
            throw new \InvalidArgumentException('invalid value for $id_unit when calling UnitsBulkUpdateRequest., must be bigger than or equal to 1.');
        }
     ...
     * Gets unit_data
     *
     * @return \KauflandSellerApi\Model\UnitPatchRequest
     */
     ...
     * Sets unit_data
     *
     * @param \KauflandSellerApi\Model\UnitPatchRequest $unit_data unit_data
     *
     * @return self
     */
