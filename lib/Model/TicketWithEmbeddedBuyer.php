...
/**
 * TicketWithEmbeddedBuyer Class Doc Comment
 *
 * @category Class
 ...
 */
class TicketWithEmbeddedBuyer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TicketWithEmbedded_buyer';
    ...
    */
    ...
    {
        if (is_null($id_buyer)) {
            throw new \InvalidArgumentException('non-nullable id_buyer cannot be null');
        }
