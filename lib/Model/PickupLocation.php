...
class PickupLocation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('dhl_post_number', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($dhl_post_number)) {
            array_push($this->openAPINullablesSetToNull, 'dhl_post_number');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('dhl_post_number', $nullablesSetToNull, true);
            if ($index !== false) {
