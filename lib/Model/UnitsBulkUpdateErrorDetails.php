...
class UnitsBulkUpdateErrorDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setIdUnit($id_unit)
    {
        ...
        if (($id_unit < 1)) {
            throw new \InvalidArgumentException('invalid value for $id_unit when calling UnitsBulkUpdateErrorDetails., must be bigger than or equal to 1.');
        }
    ...
    public function setStatusCode($status_code)
    {
        ...
        if (($status_code < 200)) {
            throw new \InvalidArgumentException('invalid value for $status_code when calling UnitsBulkUpdateErrorDetails., must be bigger than or equal to 200.');
        }
