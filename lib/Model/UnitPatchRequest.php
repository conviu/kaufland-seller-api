...
class UnitPatchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets listing_price
     *
     * @param int|null $listing_price Listing price, in integral cents of the storefront's currency (CZK for cz, EUR for de, sk). Minimum 1 cent, maximum differs by storefront (1 million EUR or 25 million CZK).
     *
     * @return self
     */
