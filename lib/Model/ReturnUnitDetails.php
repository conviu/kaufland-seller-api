...
class ReturnUnitDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'return' => '\KauflandSellerApi\Model\ModelReturn',
        'tickets' => '\KauflandSellerApi\Model\Ticket[]',
        'order_unit' => '\KauflandSellerApi\Model\OrderUnit'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('order_unit', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets return
     *
     * @param \KauflandSellerApi\Model\ModelReturn $return return
     *
     * @return self
     */
     ...
     * Sets tickets
     *
     * @param \KauflandSellerApi\Model\Ticket[]|null $tickets tickets
     *
     * @return self
     */
     ...
     * Gets order_unit
     *
     * @return \KauflandSellerApi\Model\OrderUnit|null
     */
     ...
     * Sets order_unit
     *
     * @param \KauflandSellerApi\Model\OrderUnit|null $order_unit order_unit
     *
     * @return self
     */
    public function setOrderUnit($order_unit)
    {
        if (is_null($order_unit)) {
            throw new \InvalidArgumentException('non-nullable order_unit cannot be null');
        }
