...
class ReturnDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('return_units', $data ?? [], null);
    }
    ...
    */
    ...
    public function setTrackingProvider($tracking_provider)
    {
        if (is_null($tracking_provider)) {
            array_push($this->openAPINullablesSetToNull, 'tracking_provider');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('tracking_provider', $nullablesSetToNull, true);
            if ($index !== false) {
    ...
    public function setTrackingCode($tracking_code)
    {
        if (is_null($tracking_code)) {
            ...
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('tracking_code', $nullablesSetToNull, true);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Gets status
     *
     * @return \KauflandSellerApi\Model\ReturnStatus
     */
     ...
     * Sets status
     *
     * @param \KauflandSellerApi\Model\ReturnStatus $status status
     *
     * @return self
     */
     ...
     * Gets buyer
     *
     * @return \KauflandSellerApi\Model\Buyer|null
     */
     ...
     * Sets buyer
     *
     * @param \KauflandSellerApi\Model\Buyer|null $buyer buyer
     *
     * @return self
     */
     ...
     * Gets return_units
     *
     * @return \KauflandSellerApi\Model\ReturnUnit[]|null
     */
     ...
     * Sets return_units
     *
     * @param \KauflandSellerApi\Model\ReturnUnit[]|null $return_units return_units
     *
     * @return self
     */
    public function setReturnUnits($return_units)
    {
        if (is_null($return_units)) {
            throw new \InvalidArgumentException('non-nullable return_units cannot be null');
        }
