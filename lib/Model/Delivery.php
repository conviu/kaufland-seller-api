...
class Delivery implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'pickup_location' => '\KauflandSellerApi\Model\PickupLocation'
    ];
    ...
    */
     ...
     *
     * @return \KauflandSellerApi\Model\PickupLocation
     */
     ...
     *
     * @param \KauflandSellerApi\Model\PickupLocation $pickup_location pickup_location
     *
     * @return self
     */
    public function setPickupLocation($pickup_location)
    {
        if (is_null($pickup_location)) {
            ...
            $index = array_search('pickup_location', $nullablesSetToNull, true);
            if ($index !== false) {
