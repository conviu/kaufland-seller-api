...
class OrderUnitDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'return_unit' => '\KauflandSellerApi\Model\OrderUnitDetailsReturnUnit',
    ...
    protected static array $openAPINullables = [
        ...
        'product' => true,
        'vat' => true,
        'delivery_attempt_timestamp_iso' => true,
        'tickets' => true,
        'return_unit' => true,
        'delivery' => false,
        'kss_eligible' => false
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('delivery_attempt_timestamp_iso', $data ?? [], null);
        $this->setIfExists('tickets', $data ?? [], null);
        $this->setIfExists('return_unit', $data ?? [], null);
    ...
    */
     ...
     *
     * @param \DateTime|null $delivery_attempt_timestamp_iso The attribute is only responded when explicitly requested as an embedded field
     *
     * @return self
     */
    public function setDeliveryAttemptTimestampIso($delivery_attempt_timestamp_iso)
    {
        if (is_null($delivery_attempt_timestamp_iso)) {
            array_push($this->openAPINullablesSetToNull, 'delivery_attempt_timestamp_iso');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('delivery_attempt_timestamp_iso', $nullablesSetToNull, true);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Gets tickets
     *
     * @return \KauflandSellerApi\Model\Ticket[]|null
     */
     ...
     * Sets tickets
     *
     * @param \KauflandSellerApi\Model\Ticket[]|null $tickets The attribute is only responded when explicitly requested as an embedded field
     *
     * @return self
     */
     ...
     * Gets return_unit
     *
     * @return \KauflandSellerApi\Model\OrderUnitDetailsReturnUnit|null
     */
     ...
     * Sets return_unit
     *
     * @param \KauflandSellerApi\Model\OrderUnitDetailsReturnUnit|null $return_unit return_unit
     *
     * @return self
     */
    public function setReturnUnit($return_unit)
    {
        if (is_null($return_unit)) {
            array_push($this->openAPINullablesSetToNull, 'return_unit');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('return_unit', $nullablesSetToNull, true);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
