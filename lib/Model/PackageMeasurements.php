...
class PackageMeasurements implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('weight_gram', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['weight_gram'] === null) {
            $invalidProperties[] = "'weight_gram' can't be null";
        }
    ...
    {
        return $this->container['weight_gram'];
    }

    /**
     * Sets weight_gram
     *
     * @param int $weight_gram weight_gram
     *
     * @return self
     */
    public function setWeightGram($weight_gram)
    {
        if (is_null($weight_gram)) {
            throw new \InvalidArgumentException('non-nullable weight_gram cannot be null');
        }
        $this->container['weight_gram'] = $weight_gram;
