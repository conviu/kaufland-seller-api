...
class CategoryWithEmbedded implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'fixed_fee' => 'float',
        'vat' => 'float',
        'required_attributes' => '\KauflandSellerApi\Model\Attribute[]',
        'optional_attributes' => '\KauflandSellerApi\Model\Attribute[]',
        'children' => '\KauflandSellerApi\Model\Category[]',
        'parent' => '\KauflandSellerApi\Model\Category'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('required_attributes', $data ?? [], null);
    ...
    */
    ...
    public function setIdCategory($id_category)
    {
        ...
        if (($id_category < 1)) {
            throw new \InvalidArgumentException('invalid value for $id_category when calling CategoryWithEmbedded., must be bigger than or equal to 1.');
        }
    ...
    public function setIdParentCategory($id_parent_category)
    {
        ...
        if (($id_parent_category < 1)) {
            throw new \InvalidArgumentException('invalid value for $id_parent_category when calling CategoryWithEmbedded., must be bigger than or equal to 1.');
        }
     ...
     *
     * @return \KauflandSellerApi\Model\Attribute[]|null
     */
     ...
     *
     * @param \KauflandSellerApi\Model\Attribute[]|null $required_attributes required_attributes
     *
     * @return self
     */
    public function setRequiredAttributes($required_attributes)
    {
        if (is_null($required_attributes)) {
            throw new \InvalidArgumentException('non-nullable required_attributes cannot be null');
        }
     ...
     *
     * @param \KauflandSellerApi\Model\Attribute[]|null $optional_attributes optional_attributes
     *
     * @return self
     */
     ...
     * Gets children
     *
     * @return \KauflandSellerApi\Model\Category[]|null
     */
     ...
     * Sets children
     *
     * @param \KauflandSellerApi\Model\Category[]|null $children children
     *
     * @return self
     */
     ...
     * Sets parent
     *
     * @param \KauflandSellerApi\Model\Category|null $parent parent
     *
     * @return self
     */
