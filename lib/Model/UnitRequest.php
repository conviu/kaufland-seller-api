...
class UnitRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets listing_price
     *
     * @param int $listing_price Listing price, in integral cents of the storefront's currency (CZK for cz, EUR for de, sk, at and PLN for pl). Minimum 1 cent, maximum differs by storefront (25 million CZK, 1 million EUR or 4.5 million PLN).
     *
     * @return self
     */
